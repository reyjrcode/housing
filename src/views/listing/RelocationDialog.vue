        ...
        <v-data-table :headers="headers" :items="desserts" :search="search" sort-by="calories" class="elevation-1">
            <template v-slot:top>
                ...
                <v-toolbar flat>
                                            ...
                                            <v-card class="mb-12" height="750px">
                                                ...
                                                <v-select
                                                    ...
                                                    label="Pila ang anak" required outlined> </v-select>
                                                                ...
                                                                <v-col cols="12" sm="3">
                                                                    <v-select :items="['Walk-in', 'Walk-out']"
                                                                        label="Type of application" required outlined>
                                                                    </v-select>
                                                                </v-col>
                                                                <v-col cols="12" sm="6" md="3">
                    ...
                    <v-dialog v-model="insertdialog" max-width="100%">
                        <!-- <template v-slot:activator="{ on, attrs }">
                                            ...
                                            <v-stepper-items>
                                                        ...
                                                        <v-card class="mb-1" color="grey lighten-4">
                                                            <v-card-text>
                                                                <v-container>
                                                                    <v-row>
                                                                        <v-col cols="12" sm="6" md="3">
                                                                            <v-text-field label="Apelyido" clearable
                                                                                required outlined autofocus></v-text-field>
                                                                        </v-col>
                                                                        <v-col cols="12" sm="6" md="3">
                                                                            <v-text-field label="Pangalan" clearable
                                                                                required outlined></v-text-field>
                                                                        </v-col>
                                                                        <v-col cols="12" sm="6" md="3">
                                                                            <v-text-field label="Middle Name" clearable
                                                                                required outlined></v-text-field>
                                                                        ...
                                                                        <v-col cols="12" sm="6">
                                                                            <v-select
                                                                                :items="['Job order', 'Casual', 'Regular']"
                                                                                label="Stado sa Pagpanarbaho" required
                                                                                outlined></v-select>
                                                                        </v-col>
                                                                        <v-col cols="12" sm="6" md="6">
                                                                            <v-text-field label="Contact No." clearable
                                                                                required outlined></v-text-field>
                                                                        </v-col>
                                                                        <v-col cols="12" sm="6">
                                                                            <v-text-field label="Pangalan sa Employer"
                                                                        ...
                                                                        <v-col cols="12" sm="6" md="3">
                                                                            <v-text-field label="Pangalan sa bana / asawa"
                                                ...
                                                <v-select
                                                    ...
                                                    label="Pila ang anak" required outlined> </v-select>
                                                                        ...
                                                                        <v-col cols="12" sm="3">
                                                                            <v-select :items="['Walk-in', 'Walk-out']"
                                                                                label="Type of application" required
                                                                                outlined>
                                                                            </v-select>
                                                                        </v-col>
                                                                        <v-col cols="12" sm="6" md="3">
                                                ...
                                                <v-stepper-content step="3">
                                                        ...
                                                        <v-card-text>
                                                            <v-container>
                                                                <v-row>
                                                                    ...
                                                                    <v-col cols="12" sm="6" md="6">
                                                                        <v-select
                                                                            :items="['SHFC/Home owner', 'Relocation site']"
                                                    ...
                                                    <v-btn class="ma-4" color="secondary" @click="insertdialog = false"
                                                        value="save">
                                                        Back
                                                    </v-btn>
                                                    <v-btn class="ma-4" color="secondary" @click="insertdialog = false"
